...
echo 806400 > /sys/devices/system/cpu/cpufreq/policy2/scaling_min_freq
echo 806400 > /sys/devices/system/cpu/cpufreq/policy2/scaling_max_freq
echo 806400 > /sys/devices/system/cpu/cpufreq/policy5/scaling_min_freq
echo 806400 > /sys/devices/system/cpu/cpufreq/policy5/scaling_max_freq
echo 806400 > /sys/devices/system/cpu/cpufreq/policy7/scaling_min_freq
echo 806400 > /sys/devices/system/cpu/cpufreq/policy7/scaling_max_freq
